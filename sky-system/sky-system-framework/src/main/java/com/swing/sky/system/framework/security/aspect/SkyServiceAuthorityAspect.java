package com.swing.sky.system.framework.security.aspect;
...
public class SkyServiceAuthorityAspect {
     ...
     * 使用注解标识切点(方法级别或类级别）
     */
    @Pointcut("@annotation(com.swing.sky.system.module.annotation.SkyServiceAuthority)" + "|| @within(com.swing.sky.system.module.annotation.SkyServiceAuthority)")
