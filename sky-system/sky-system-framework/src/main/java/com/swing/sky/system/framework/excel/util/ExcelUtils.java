package com.swing.sky.system.framework.excel.util;

import com.swing.sky.system.module.annotation.Excel;
import com.swing.sky.system.module.annotation.Excels;
import com.swing.sky.common.utils.ConvertUtils;
...
public class ExcelUtils<T> {
     ...
     * @return 结果
     */
    public SkyResponse exportExcel(List<T> list, String sheetName) {
     ...
     * @return 结果
     */
    public SkyResponse importTemplateExcel(String sheetName) {
     ...
     * @return 结果
     */
    public SkyResponse exportExcel() {
        ...
        try {
            ...
            wb.write(out);
            return SkyResponse.success(filename);
        } catch (Exception e) {
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = SkyConfig.getDownloadPath() + filename;
