...
public class DataSourceConfig {
     ...
     */
    @Bean
    public DynamicDataSource dynamicDataSource(DataSource centerDataSource, DataSource tikuDataSource) {
        //数据源集合(指定集合的大小）
        ...
        return new DynamicDataSource(centerDataSource, dataSources);
    }
